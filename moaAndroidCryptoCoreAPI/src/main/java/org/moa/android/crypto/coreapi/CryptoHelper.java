...
public class CryptoHelper {
    ...
    public Symmetric newSymmetricInstance(String cryptoNameModePadType, byte[] ivBytes, byte[] keyBytes) {
        return new Symmetric(cryptoNameModePadType, ivBytes, keyBytes);
    }
